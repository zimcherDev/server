...
ActiveRecord::Schema.define(version: 20160117224706) do
  ...
  add_index "subscriptions", ["zim_id"], name: "index_subscriptions_on_zim_id"
  ...
  create_table "zims", force: :cascade do |t|
    t.string   "name"
    t.text     "description"
    t.string   "image_url"
    t.string   "publicity"
